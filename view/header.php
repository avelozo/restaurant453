  ...
  <body>
    <div class="previewHeader">
    	<img id="logoHeader" src="../img/logoRousseff120.png" alt="Logout">
    	<ul class="navHeader">
    	 <li class="liClass">Welcome</li>
    	 <li class="liClass"><img src="../img/logout.png" alt="Logout"></li>
      </ul>
    </div>
      ...
      <div class="leftMenu">
        <ul>
          ...
          <li class="leftPanelLi"><a href="../view/stock.php"><img src="../img/istock.png" class="leftPIcon"></i> <span>Stock</span></a></li>
        	<li class="leftPanelLi"><a href="../view/chart.php"><img src="../img/ichart.png" class="leftPIcon"></i> <span>Charts</span></a></li>
        </ul>
      </div>
    </div>  
